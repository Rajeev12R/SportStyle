...
export default function HomePage() {
  ...
  return (
    <div className="space-y-16">
      ...
      <section className="relative bg-gradient-to-br from-primary/80 via-primary to-accent/70 text-primary-foreground py-20 md:py-32 rounded-xl shadow-2xl overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-lg md:text-xl mb-10 max-w-2xl mx-auto">
            Discover premium sportswear and custom uniforms designed for peak performance and ultimate comfort.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/sportswear" passHref>
              <Button size="lg" className="bg-accent text-accent-foreground hover:bg-accent/90 transform hover:scale-105 transition-transform duration-300 shadow-lg">
                Shop Sportswear <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
            </Link>
            <Link href="/uniforms" passHref>
              <Button variant="outline" size="lg" className="text-primary-foreground border-primary-foreground hover:bg-primary-foreground/10 transform hover:scale-105 transition-transform duration-300 shadow-lg">
      ...
      {/* Categories Section */}
      <section>
        <h2 className="text-3xl font-bold text-center mb-4 text-foreground">Explore Our Collections</h2>
        <p className="text-center text-muted-foreground mb-10 max-w-xl mx-auto">
          From individual athletic gear to full team kits, find exactly what you need to perform your best.
        </p>
          ...
          <Link href="/sportswear" className="group block">
            <div className="relative rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transition-shadow duration-300 aspect-video">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex flex-col justify-end p-6">
                ...
                <Button variant="secondary" size="sm" className="self-start bg-white/90 text-primary hover:bg-white">
      ...
      <section className="bg-secondary py-16 rounded-xl shadow-lg">
        <div className="container mx-auto px-4 text-center">
          ...
          <h2 className="text-3xl font-bold mb-4 text-secondary-foreground">Need Style Advice?</h2>
          <p className="text-lg text-muted-foreground mb-8 max-w-xl mx-auto">
            Let our AI Style Assistant help you find the perfect gear based on your preferences.
          </p>
      ...
      <section>
        <h2 className="text-3xl font-bold text-center mb-10 text-foreground">Why Choose SwiftStride?</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          <div className="p-6 bg-card rounded-lg shadow-md">
            ...
            <p className="text-sm text-muted-foreground">Durable materials and craftsmanship for long-lasting wear.</p>
          </div>
          <div className="p-6 bg-card rounded-lg shadow-md">
            <Bot className="h-12 w-12 text-primary mx-auto mb-4" />
            <h3 className="text-xl font-semibold mb-2 text-card-foreground">Innovative Design</h3>
            <p className="text-sm text-muted-foreground">Modern styles infused with performance-enhancing technology.</p>
          </div>
          <div className="p-6 bg-card rounded-lg shadow-md">
            <Shield className="h-12 w-12 text-primary mx-auto mb-4" />
            <h3 className="text-xl font-semibold mb-2 text-card-foreground">Customization Experts</h3>
            <p className="text-sm text-muted-foreground">Tailor-made uniforms to perfectly represent your team.</p>
          </div>
        </div>
      </section>
    </div>
